        ...
        <div className="row contactus">
          ...
          <div className="col-md-11 p-3 mb-4">
            ...
            <p className="text-justify mt-2">
              Welcome to Superstore-360! We are dedicated to providing you with
              a seamless and enjoyable shopping experience. We are committed to
              offering high-quality products, excellent customer service, and a
              user-friendly platform for all your shopping needs.
            </p>
            <p className="text-justify mt-2">
              We understand that your time is valuable, which is why we strive
              to make your shopping experience as convenient as possible.
              Whether you're looking for the latest fashion trends, home
              essentials, or unique gifts, we have a wide selection of products
              to meet your needs.
            </p>
            <p className="text-justify mt-2">
              Thank you for choosing Superstore-360, and we look forward to
