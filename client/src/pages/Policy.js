    ...
    <Layout title={"Privacy Policy"}>
      <div className="card m-4 border shadow p-3" data-bs-theme="dark">
        ...
        <div className="p-3">
          <h2>Introduction</h2>
          <p>
            Superstore-360 is committed to protecting the privacy of our
            customers and visitors. This Privacy Policy describes the
          ...
          <ul>
            ...
            <li>
              Order information: product details, purchase history, order
